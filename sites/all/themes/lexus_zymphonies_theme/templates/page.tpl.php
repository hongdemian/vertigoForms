      ...
      <?php if (theme_get_setting('social_links')): ?>
        <span class="social-icons">
         <ul>
          ...
          <li><a class="linkedin" href="<?php echo theme_get_setting('linkedin_profile_url'); 
?>" target="_blank" rel="me"><i class="fa fa-linkedin"></i></a></li>
  ...
  <div class="credits">
    <?php print t('Designed by Damien'); ?>
  </div>
